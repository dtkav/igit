...
static const char * const merge_base_usage[] = {
	N_("igit merge-base [-a | --all] <commit> <commit>..."),
	N_("igit merge-base [-a | --all] --octopus <commit>..."),
	N_("igit merge-base --is-ancestor <commit> <commit>"),
	N_("igit merge-base --independent <commit>..."),
	N_("igit merge-base --fork-point <ref> [<commit>]"),
	NULL
};
